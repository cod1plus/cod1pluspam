...
init()
{
	logprint("_halftime::init\n");
	
	if(game["firstInit"])
	{
		game["is_halftime"] = false;

		maps\mp\gametypes\global\_global::precacheString2("STRING_HALFTIME", &"Half-time");
		maps\mp\gametypes\global\_global::precacheString2("STRING_TEAM_AUTO_SWITCH", &"Team Auto-Switching");
	}
}
...
Do_Half_Time()
{
	...
	{
		logprint("_halftime:: Invoked map_restart(true)\n");
		map_restart(true);
	}
}
...
HUD_TeamSwap()
{
	...
	// Halftime
	halftime = maps\mp\gametypes\global\_global::addHUD(x, y, 1.2, (1,1,0), "center", "middle", "right");
	halftime maps\mp\gametypes\global\_global::showHUDSmooth(.5);
	halftime setText(game["STRING_HALFTIME"]);
	y += 20;

	// Team auto switch
	switching = maps\mp\gametypes\global\_global::addHUD(x, y, 1.2, (1,1,0), "center", "middle", "right");
	switching maps\mp\gametypes\global\_global::showHUDSmooth(.5);
