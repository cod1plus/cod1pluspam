...
GetCvars(arr)
{
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sd_half_round", 15);	// Number of rounds when half-time starts. 0=ignored
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sd_end_round", 30);	// Number of rounds when map ends. 0=ignored
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sd_end_score", 16);	// Number of score when map ends. 0=ignored
