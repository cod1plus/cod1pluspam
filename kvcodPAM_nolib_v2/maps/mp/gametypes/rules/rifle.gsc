...
{
	// Rifles-only mode
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_rifle_mode", 1);


	// Nade spawn counts for each class
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_boltaction_nades", 0);
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_sniper_nades", 0);
	...
	arr = maps\mp\gametypes\global\_global::ruleCvarDefault(arr, "scr_pistol_allow_drop", 0);
