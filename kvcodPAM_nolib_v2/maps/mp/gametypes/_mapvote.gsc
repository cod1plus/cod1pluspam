...
Init()
{
	logprint("_mapvote::init\n");
	
	maps\mp\gametypes\global\_global::addEventListener("onCvarChanged", ::onCvarChanged);

	//original value "1" - change to "0" to disable map_vote
	maps\mp\gametypes\global\_global::registerCvar("scr_map_vote", "BOOL", 0);
	maps\mp\gametypes\global\_global::registerCvar("scr_map_vote_replay", "BOOL", 0);

	if(game["firstInit"])
	{
		maps\mp\gametypes\global\_global::precacheString2("STRING_MAPVOTE_PRESS_FIRE", &"Press ^2FIRE^7 to vote                           Votes");
		maps\mp\gametypes\global\_global::precacheString2("STRING_MAPVOTE_TIME_LEFT", &"Time Left: ");
		maps\mp\gametypes\global\_global::precacheString2("STRING_MAPVOTE_HEADER", &"Next Map Vote");
	}
...
CreateHud()
{
	level.vote_hud_bgnd = maps\mp\gametypes\global\_global::newHudElem2();
	...
	level.vote_header = maps\mp\gametypes\global\_global::newHudElem2();
	...
	level.vote_headerText = maps\mp\gametypes\global\_global::newHudElem2();
	...
	level.vote_leftline = maps\mp\gametypes\global\_global::newHudElem2();
	...
	level.vote_rightline = maps\mp\gametypes\global\_global::newHudElem2();
	...
	level.vote_bottomline = maps\mp\gametypes\global\_global::newHudElem2();
	...
	level.vote_hud_timeleft = maps\mp\gametypes\global\_global::newHudElem2();
	...
	level.vote_hud_instructions = maps\mp\gametypes\global\_global::newHudElem2();
...
PlayerVote()
{
	...
	self.vote_indicator = maps\mp\gametypes\global\_global::newClientHudElem2( self );
