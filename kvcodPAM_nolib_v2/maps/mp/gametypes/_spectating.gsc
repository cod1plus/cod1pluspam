...
init()
{
	logprint("_spectating::init\n");
	maps\mp\gametypes\global\_global::addEventListener("onCvarChanged", ::onCvarChanged);

	maps\mp\gametypes\global\_global::registerCvar("scr_spectatefree", "BOOL", 0);
	maps\mp\gametypes\global\_global::registerCvar("scr_spectateenemy", "BOOL", 0);
	maps\mp\gametypes\global\_global::registerCvar("scr_streamersystem", "BOOL", 0);
