...
{
	return maps\mp\gametypes\global\rules::PAMModeContains(strValue);
}
...
{
	return maps\mp\gametypes\global\string::isDigitalNumber(strValue);
}
isDigit(char)
{
...
toLower(strToLower)
{
	return maps\mp\gametypes\global\string::toLower(strToLower);
}
getsubstr(string, from, to)
{
	return maps\mp\gametypes\global\string::getsubstr(string, from, to);
}