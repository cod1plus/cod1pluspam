...
Init()
{
	...
	maps\mp\gametypes\global\_global::addEventListener("onConnecting",    ::onConnecting);
	...
	maps\mp\gametypes\global\_global::registerCvarEx("I", "scr_bots_add", "INT", 0, 0, 64); 		// add <num> bots to the server
	maps\mp\gametypes\global\_global::registerCvarEx("I", "scr_bots_remove", "INT", 0, 0, 64); 	// remove <num> bots from the server
	maps\mp\gametypes\global\_global::registerCvarEx("I", "scr_bots_removeAll", "BOOL", 0);		// remove all bots from server
	maps\mp\gametypes\global\_global::registerCvarEx("I", "scr_bots_freeze", "BOOL", 1); 		// freeze bots movement
	maps\mp\gametypes\global\_global::registerCvarEx("I", "scr_bots_spam", "FLOAT", 0); 		// periodically connect and disconnect a bot - the value set time cycle in seconds
}
	...
	switch(cvar)
	{
		case "scr_bots_add":
			if (value > 0)
			{
				...
				maps\mp\gametypes\global\_global::changeCvarQuiet("scr_bots_add", 0);
			}
			return true;
		...
		case "scr_bots_remove":
			if(value > 0) {
				...
				maps\mp\gametypes\global\_global::changeCvarQuiet("scr_bots_remove", 0);
			}
			return true;
		...
		case "scr_bots_removeall":
			if(value == 1)
			{
				...
				maps\mp\gametypes\global\_global::changeCvarQuiet("scr_bots_removeAll", 0);
			}
			return true;
