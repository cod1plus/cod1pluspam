/*
  rPAMext Version: v29 (kvcodPAM v2.18)     
...
//		maps\mp\gametypes\global\_global::precacheString2("STRING_VERSION_INFO", &"zPAM 3.34 for vCoD"); // ZPAM_RENAME
		maps\mp\gametypes\global\_global::precacheString2("STRING_VERSION_INFO_1", &"rPAM & kmPAM v2.19");
//		maps\mp\gametypes\global\_global::precacheString2("STRING_VERSION_INFO_2", &"LAN in Budapest, Hungary");
//		maps\mp\gametypes\global\_global::precacheString2("STRING_VERSION_INFO_3", &"CoDBASE Europe");
...
PAM_Header(fadein)
{
	...
	pam_version setText(game["STRING_VERSION_INFO_1"]);

//	pam_version2 = maps\mp\gametypes\global\_global::addHUD(630, 36, 0.55, (0.8,1,1), "right", "top", "right");
//	if (fadein) pam_version2 maps\mp\gametypes\global\_global::showHUDSmooth(.5);
//	pam_version2 setText(game["STRING_VERSION_INFO_2"]);

//	pam_version3 = maps\mp\gametypes\global\_global::addHUD(630, 44, 0.55, (0.8,1,1), "right", "top", "right");
//	if (fadein) pam_version3 maps\mp\gametypes\global\_global::showHUDSmooth(.5);
//	pam_version3 setText(game["STRING_VERSION_INFO_3"]);
...
//	pam_version2 thread maps\mp\gametypes\global\_global::destroyHUDSmooth(0.5);
//	pam_version3 thread maps\mp\gametypes\global\_global::destroyHUDSmooth(0.5);
