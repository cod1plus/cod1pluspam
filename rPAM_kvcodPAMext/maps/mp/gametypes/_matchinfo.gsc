...
{
//216	logprint("_matchinfo::determineTeamByHistoryCvars\n");
...
{
//216	logprint("_matchinfo::determineTeamByFirstConnected\n");
...
//216: Must be run as thread [player] UpdatePlayerCvars
UpdatePlayerCvars()
{
//216
...
//v210
	for (;;)
	{
		...
		*** Determinate team names, side, score
		...
		if (game["scr_matchinfo"] == 2)
		{
//v216: Correction of team names update
...
*/
//--
//216	thread UpdateCvarsForPlayers();
